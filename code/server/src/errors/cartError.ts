...
class EmptyCart404Error extends Error {
    customMessage: string
    customCode: number
...
export { CartNotFoundError, ProductInCartError, ProductNotInCartError, WrongUserCartError, EmptyCartError, EmptyCart404Error }